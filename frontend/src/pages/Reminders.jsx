...
function Reminders() {
    ...
    const handleSubmit = async (e) => {
        ...
        // prevent past date
        if (new Date(form.reminder_date) <= new Date()) {
                        ...
                        <div className="reminder-form">
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    // prevent selecting past date/time from the picker itself
                    ...
                    <div className="reminders-list">
                        {reminders.map(reminder => {
                            ...
                            return (
                                <div
                                    key={reminder.id}
                                    className={`reminder-card ${reminder.sent
                                            ? 'reminder-sent'
                                            : isDueSoon
                                                ? 'border-l-4 border-l-red-400 bg-white rounded-xl border border-slate-200 shadow-sm p-5'
                                                : 'reminder-pending'
                                        }`}
                                >
                                    ...
                                    <div className="reminder-status">
                                        <span className={`badge ${reminder.sent
                                                ? 'badge-sent'
                                                : isDueSoon
